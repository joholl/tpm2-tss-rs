//! [u8; N] with N > 32 bytes are not supported by serde
//! (https://github.com/serde-rs/serde/issues/1937). Use a workaround for now,
//! see https://github.com/serde-rs/serde/issues/631#issuecomment-322677033
