use crate::alg::{
    AlgAsymScheme, AlgKdf, AlgKeyedHashScheme, AlgSigScheme, AlgSym, AlgSymMode, AlgSymObj,
};
use crate::alg::{AlgHash, EccCurve};
use crate::bitfields::CommandCodeAttributes;
use crate::constants::{Capability, CommandCode};
use crate::de::{deserialize_u16_sized_vec, deserialize_u32_sized_vec};
...
use crate::structs::{
    ...
    EncSchemeOAEP, KeySchemeECDH, KeySchemeECMQ, NVCertifyInfo, NVDigestCertifyInfo, PCRSelection,
    QuoteInfo, SchemeHMAC, SchemeKDF2, SchemeKdf1Sp800_108, SchemeKdf1Sp800_56a, SchemeMGF1,
    SchemeXOR, SessionAuditInfo, SigSchemeECDAA, SigSchemeECDH, SigSchemeECDSA, SigSchemeECSCHNORR,
    SigSchemeRSAPSS, SigSchemeRSASSA, SigSchemeSM2, TaggedPCRSelect, TaggedPolicy, TaggedProperty,
    TimeAttestInfo,
};
...
/// TPMT_SYM_DEF_OBJECT/TPMS_SYMCIPHER_PARMS: TPMI_ALG_SYM_OBJECT, TPMU_SYM_DEF_OBJECT
#[derive(Deserialize, Serialize, Debug, Clone, Default, PartialEq)]
#[repr(u16)]
...
/// TPMT_PUBLIC: TPMU_PUBLIC_PARMS, TPMU_PUBLIC_ID
